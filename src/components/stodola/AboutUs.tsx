...
export default function AboutUs() {
  return (
    <>
      <h2 className="text-TextN font-sora text-xl py-10 ">O NAS</h2>
      <h3 className="text-TextN font-sora text-3xl md:text-4xl font-semibold tracking-widest">
        NATURALNA
      </h3>
      <h3 className="text-TextN font-ogg text-3xl md:text-4xl font-thin tracking-widest">
        REGENERACJA
      </h3>
      <p className="text-TextN font-sora px-5 md:px-0 text-sm md:text-lg text-center py-10 max-w-[900px] tracking-wide ">
        ...
        podglądnij biegającego po trawie jeża i skaczące żaby. <br />
        <br /> Uprawiaj sport &ndash; wskocz na rower, popłyń łódką lub
        kajakiem. Weź ze sobą wędkę, mamy u siebie istny raj dla poławiaczy ryb.
        <br /> <br /> Czas na naturalną regenerację.
      </p>
    </>
  );
}
